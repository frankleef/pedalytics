    ...
    <div style={{ minHeight: "100vh", background: T.bg, display: "flex" }}>
      <aside style={{ width: 246, flex: "none", background: "oklch(0.975 0.006 88)", borderRight: `1px solid ${T.cardBorder}`, display: "flex", flexDirection: "column", padding: "22px 16px", position: "sticky", top: 0, height: "100vh", overflowY: "auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 11px", borderTop: `1px solid ${T.cardBorder}`, marginTop: 8 }}>
          <div style={{ width: 32, height: 32, flex: "none", borderRadius: "50%", background: T.slate, display: "flex", alignItems: "center", justifyContent: "center", font: "800 13px var(--font-nunito), sans-serif", color: "#f7f3eb" }}>A</div>
          <div style={{ display: "flex", flexDirection: "column", gap: 1, overflow: "hidden" }}>
            <span style={{ font: "700 12.5px var(--font-nunito), sans-serif", color: "oklch(0.36 0.012 68)", whiteSpace: "nowrap" }}>Beheerder</span>
            <span style={{ font: "600 11px var(--font-nunito), sans-serif", color: "oklch(0.62 0.012 76)", whiteSpace: "nowrap" }}>Admin-toegang</span>
          </div>
        </div>
      </aside>
