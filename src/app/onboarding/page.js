    ...
    <div style={{ minHeight: "100vh", background: "oklch(0.962 0.012 84)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--font-nunito), 'Nunito', sans-serif", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <p style={{ margin: "8px 0 0", font: "600 14px/1.5 var(--font-nunito), sans-serif", color: "oklch(0.5 0.02 74)", textWrap: "pretty" }}>
            Om je trainingsdata te laden heb je een API-key van intervals.icu nodig.
          </p>
        </div>
