...
export const SESSIE_ARCHETYPES = {
  ...
  drempel_intervallen: [
    ...
    },
    {
      id: 'ou_standaard',
      naam: 'Over-unders',
      structuur: '6× [2 min @ 88% → 1 min @ 105% FTP], continu (geen rust tussen cycli), Z2-sluitstuk (zwaarste variant: 2-4 min hard start @ 110-115% FTP direct door in de over-unders, coach-praktijk)',
      tss_range: [70, 77],
    ...
    },
    {
      ...
      structuur: '4× [3 min @ 88% → 2 min @ 103% FTP], continu (geen rust tussen cycli), Z2-sluitstuk',
      tss_range: [73, 76],
      fase_beschikbaar: ['sweetspot', 'drempel', 'vo2max', 'consolidatie'],
    },
    {
  ...
  vo2max_intervallen: [
    {
      // vo2_5x5_std/vo2_4x6 herkalibreerd (vervolgticket chunk 1, vo2-familie-
      // batch): hadden een oversized herstel-blok tussen reps, onafhankelijk
      // op eigen naam herkalibreerd. vo2_6x4 bewust ongewijzigd — andere fout
      // (werkduur zelf onjuist), apart behandeld.
      id: 'vo2_5x5',
      naam: 'Klassieke 5×5',
  ...
  gemengd: [
    ...
    {
      // Vervolgticket chunk 1: "direct" in de structuurtekst suggereerde geen
      // rust tussen de 2 VO2max-herhalingen, maar de data levert bewust ~5 min
      // hersteltussen — besloten om de data te laten staan en de tekst te
      // corrigeren i.p.v. andersom (data ongewijzigd, tss blijft 85 @90min,
      // binnen de bestaande range).
      id: 'omgekeerde_wereld',
      naam: 'Omgekeerde wereld',
      structuur: '2× 4 min VO2max (~5 min hersteltussen) na opwarming → 15 min sweetspot → 1× 4 min VO2max',
      tss_range: [65, 85],
      fase_beschikbaar: ['sweetspot', 'drempel', 'consolidatie', 'vo2max'],
    },
    {
      ...
      structuur: '8 min Z2 → 8 min sweetspot → 8 min Z2 → 8 min drempel → 8 min Z2 → 8 min sweetspot → 8 min Z2, continu',
      tss_range: [40, 103],
      fase_beschikbaar: ['sweetspot', 'drempel', 'consolidatie', 'vo2max'],
    },
    {
