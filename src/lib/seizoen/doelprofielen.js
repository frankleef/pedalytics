  ...
  ftp: {
    ...
    fases: [
      { naam: "Basis", weken: [1,2,3], z1z2_doel: 0.90,
        ...
        sessietypes: ["z2_vlak","z2_variabel","kracht_lage_cadans","z1_herstel"],
        kracht_lage_cadans_max_per_2_weken: 1 },
      { naam: "Sweetspot", weken: [5,6,7], z1z2_doel: 0.80,
        max_intensiteit_per_week: 2,
        sessietypes: ["sweetspot_intervallen","z2_vlak","z2_variabel","z1_herstel"] },
      { naam: "Drempel", weken: [9,10,11], z1z2_doel: 0.75,
        max_intensiteit_per_week: 2,
        sessietypes: ["drempel_intervallen","over_under","pyramide","z2_vlak","z1_herstel"] },
      { naam: "Consolidatie", weken: [12], z1z2_doel: 0.80,
        max_intensiteit_per_week: 1,
        sessietypes: ["z2_variabel","drempel_intervallen","z1_herstel"] },
      { naam: "Test", weken: [13], z1z2_doel: 0.90,
        max_intensiteit_per_week: 0,
        sessietypes: ["z2_vlak","ramp_test"] },
    ],
  },
  ...
  aerobe_basis: {
    ...
    fases: [
      { naam: "Aerobe opbouw 1", weken: [1,2,3], z1z2_doel: 0.95,
        max_intensiteit_per_week: 0,
        sessietypes: ["z2_vlak","z2_variabel","z1_herstel"],
      ...
      { naam: "Aerobe verdieping", weken: [9,10,11], z1z2_doel: 0.88,
        max_intensiteit_per_week: 1,
        sessietypes: ["z2_variabel","sweetspot_intervallen","z1_herstel"],
  ...
  klimmen: {
    ...
    fases: [
      ...
      { naam: "Sweetspot", weken: [5,6,7], z1z2_doel: 0.78,
        max_intensiteit_per_week: 2,
        sessietypes: ["sweetspot_intervallen","kracht_lage_cadans","z2_variabel","z1_herstel"] },
      { naam: "Drempel + VO2max", weken: [9,10], z1z2_doel: 0.73,
        max_intensiteit_per_week: 2,
        sessietypes: ["drempel_intervallen","over_under","vo2max_intervallen","z2_vlak","z1_herstel"] },
      { naam: "Klimspecifiek", weken: [11], z1z2_doel: 0.70,
        max_intensiteit_per_week: 2,
        sessietypes: ["vo2max_intervallen","pyramide","z2_vlak","z1_herstel"] },
      { naam: "Consolidatie", weken: [12], z1z2_doel: 0.80,
        max_intensiteit_per_week: 1,
        sessietypes: ["z2_variabel","sweetspot_intervallen","z1_herstel"] },
      { naam: "Test", weken: [13], z1z2_doel: 0.90,
  ...
  uithoudingsvermogen: {
    ...
    fases: [
      ...
      { naam: "Sweetspot hardening", weken: [9,10,11], z1z2_doel: 0.83,
        max_intensiteit_per_week: 1,
        sessietypes: ["sweetspot_intervallen","z2_vlak","z1_herstel"] },
      ...
      { naam: "Taper", weken: [13], z1z2_doel: 0.95,
        max_intensiteit_per_week: 0,
        sessietypes: ["z2_vlak","z1_herstel"] },
    ],
  },
