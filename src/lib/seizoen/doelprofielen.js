  ...
  ftp: {
    ...
    fases: [
      { naam: "Basis", weken: [1,2,3], z1z2_doel: 0.90,
        ...
        sessietypes: ["z2_vlak","z2_duur","kracht_lage_cadans","z1_herstel"],
        kracht_lage_cadans_max_per_2_weken: 1 },
      { naam: "Sweetspot", weken: [5,6,7], z1z2_doel: 0.80,
        max_intensiteit_per_week: 2,
        sessietypes: ["sweetspot_intervallen","z2_vlak","z2_duur","z1_herstel"] },
  ...
  aerobe_basis: {
    ...
    fases: [
      { naam: "Aerobe opbouw 1", weken: [1,2,3], z1z2_doel: 0.95,
        max_intensiteit_per_week: 0,
        sessietypes: ["z2_vlak","z2_duur","z1_herstel"],
  ...
  sprint: {
    ...
    fases: [
      { naam: "Aerobe basis", weken: [1,2,3], z1z2_doel: 0.88,
        max_intensiteit_per_week: 1,
        sessietypes: ["z2_vlak","z2_duur","sprint_neuraal","z1_herstel"],
...
export function faseInstellingen(profiel, faseNaam) {
  ...
  if (normaal === "overgangsfase") {
    ...
    if (ss) return { ...ss, naam: "Overgangsfase", max_intensiteit_per_week: 2, sessietypes: ["sweetspot_lang", "drempel_intervallen", "z2_vlak", "z2_duur", "z1_herstel"] };
  }
  return null;
}
